...
| 25–32 | The takeaway, then the ask: this is what AI Unlocked does for Houston businesses. |
...
| 0:04 | "I had one booked in twenty-nine minutes." | [ hard cut to black, timer runs up to 29:14 ] **29:14** |
...
| 0:13 | "I wrote a small Python script that opens every calendar and reads every day." | [ code types in ] |
| 0:16 | "GitHub runs it free, every thirty minutes, forever. No server. No app." | [ chips light up: runs on GitHub / no server / $0 ] |
| 0:19 | "It checked every thirty minutes, all night, every night." | [ log rows stack, all ✗, counter climbing ] |
...
| 0:27 | "That's what I do. Whatever your business still checks by hand, I build the thing that does it." | **I build the thing that does it.** |
| 0:30 | "AI Unlocked, Houston. DM me." | **AI Unlocked · Houston — DM me.** |
...
| 0:09 | "A small Python script. It opens the appointment page, picks each branch, opens the calendar, and reads which days aren't red." | [ code types in ] |
...
| 0:20 | "Every thirty minutes, all week. Then 6:02 in the morning —" | [ green row, punch in ] |
...
| 0:28 | "If your business is still refreshing something by hand, that's what I fix. AI Unlocked, Houston. DM me." | **AI Unlocked · Houston — DM me.** |
...
| 0:24 | "And it's not a DMV thing — this works on any page your team checks by hand. Booking sites, supplier portals, permit queues." | [ end card ] |
| 0:28 | "I build these for Houston businesses. AI Unlocked. DM me." | **AI Unlocked · Houston — DM me.** |
...
> Harris County had zero appointments for four months. I had one booked in 29 minutes.
> The site only lets you see one branch and one month at a time — so a small
> script checks all of them every 30 minutes and emails me when a day opens up.
> Runs free on GitHub. No server, no app, no $49 "expediter."
>
> This is what AI Unlocked does for Houston businesses: whatever your team still
> checks, refreshes, or retypes by hand, we build the thing that does it. DM me.
>
> #houston #htx #htxlife #houstonbusiness #houstonsmallbusiness #aiconsulting
> #automation #python #buildinpublic #texasdmv

**Cover frame:** `demo/out/stills/t003.0.png` — the red wall under **EVERY SINGLE DAY.**

**Say the numbers you can stand behind.** The 29:14 is your own booking time. "Every thirty minutes, all night" is the real schedule. Nothing in the VO claims a run count.
